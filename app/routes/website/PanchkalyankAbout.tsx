  ...
  return (
    <div >
      <section className="container mx-auto p-4">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4 mt-8">
          <img src="/images/garbh.png" alt="Panchkalyank" className="mx-auto  h-[350px]" />
          <div className="flex-1 text-center">
            <h4 className='text-2xl font-semibold justify-center'>
              गर्भ कल्याणक
            </h4>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4 mt-8">
          <img src="/images/janam.png" alt="Panchkalyank" className="mx-auto  h-[350px]" />
          <div className="flex-1 text-center">
            <h4 className='text-2xl font-semibold justify-center'>
              जन्म कल्याणक
            </h4>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4 mt-8">
          <img src="/images/tap.png" alt="Panchkalyank" className="mx-auto  h-[350px]" />
          <div className="flex-1 text-center">
            <h4 className='text-2xl font-semibold justify-center'>
              तप कल्याणक
            </h4>
            <p className="mt-4 text-xl leading-8 text-center text-zinc-500 max-md:max-w-full">
              यहां स्थापना-निक्षेप से तीर्थंकर भगवान का तप कल्याणक मनाया जा रहा है । पूर्व में जो तीर्थंकर भगवान हो गये हैं, उन्हें वर्तमान ज्ञान में याद करके स्थापना की
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4 mt-8">
          <img src="/images/gyan.png" alt="Panchkalyank" className="mx-auto  h-[350px]" />
          <div className="flex-1 text-center">
            <h4 className='text-2xl font-semibold justify-center'>
              ज्ञान कल्याणक
            </h4>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4 mt-8">
          <img src="/images/moksh.png" alt="Panchkalyank" className="mx-auto  h-[350px]" />
          <div className="flex-1 text-center">
            <h4 className='text-2xl font-semibold justify-center'>
              मोक्ष कल्याणक
            </h4>
...
export default PanchkalyankAbout