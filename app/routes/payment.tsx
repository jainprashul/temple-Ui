      ...
      <div className="space-y-2 lg:w-1/3">
        <form >
          <div className="flex flex-col space-y-2">
            <Autocomplete onValueChange={onNameChange} name="name" title="Name" placeholder="Search Devotee Names" suggestions={suggestions} />
            ...
            <input name='amount' type="number" className="input input-bordered" />
          </label>
